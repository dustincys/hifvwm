...
def get_download_path():
    # By default images are saved to '/home/[user]/.fvwm/tmp/'
    default_path = os.path.join(os.path.expanduser('~'), '.fvwm', 'tmp')
...
#            change_screensaver(image_path)
            ...
            with open(download_path + "/image-details.txt", "a+") as myfile:
                myfile.write(text)
            os.rename(image_path, os.path.join(download_path, "temp.jpg"))
